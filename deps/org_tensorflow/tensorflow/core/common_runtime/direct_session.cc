...
Status DirectSession::CreateExecutors(
  ...
  const uint64 CreateExecutors_start = Env::Default()->NowMicros();
  ...
  const uint64 CreateGraphs_start = Env::Default()->NowMicros();
  ...
  LOG(INFO) << "*******Kkq: this is CreateExecutors: CreateGraphs Took:"
            << GetLatencyMicroseconds(CreateGraphs_start) << " microseconds.";
  ...
  LOG(INFO) << "*******Kkq: this is CreateExecutors: before GraphOptimizer Took:"
            << GetLatencyMicroseconds(CreateExecutors_start) << " microseconds.";

  LOG(INFO)<<"****kkq:this is CreateExecutors line 1371 about graphoptimizer";

  const uint64 GraphOptimizer_start = Env::Default()->NowMicros();
  ...
  LOG(INFO) << "*******Kkq: this is CreateExecutors ：GraphOptimizer:  Took:"
            << GetLatencyMicroseconds(GraphOptimizer_start) << " microseconds.";
  ...
  *out_func_info = std::move(func_info);
  ...
  LOG(INFO) << "*******Kkq: this is CreateExecutors:  Took:"
            << GetLatencyMicroseconds(CreateExecutors_start) << " microseconds.";
...
Status DirectSession::MakeCallable(const CallableOptions& callable_options,
  ...
  LOG(INFO)<<"*****kkq: this is MakeCallable~ line 1863";
  std::unique_ptr<ExecutorsAndKeys> ek;
  std::unique_ptr<FunctionInfo> func_info;
