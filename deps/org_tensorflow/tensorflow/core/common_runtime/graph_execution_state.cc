...
Status GraphExecutionState::BuildGraph(const BuildGraphOptions& options,
  ...
  // LOG(INFO) << "*******Kkq: this is BuildGraph OptimizeGraph:  Took:"
  //           << GetLatencyMicroseconds(start_time_usecs) << " microseconds.";
  ...
  *out = std::move(dense_copy);
    ...
    // LOG(INFO) << "*******Kkq: this is BuildGraph :  Took:"
    //         << GetLatencyMicroseconds(start_time_usecs) << " microseconds.";
